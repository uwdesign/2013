...
(function() {
  var Boxes, Designers, Global, Menu, Moment, Posts, images_url, root_url;
  ...
  Global = {
    init: function() {
      ...
      $('.designer-single__posts-list a').on('click', function(e) {
  ...
  Moment = {
    enchiladas: function() {
      $('#moment > div').each(function() {
        var img;

        img = $(this).data('img');
        return $(this).css('background', 'url(' + images_url + img + '.png)');
      });
      if (!$.browser.mobile) {
        return skrollr.init();
      }
  ...
  Boxes = {
    ...
    mouseLeaveHandler: function() {
      return $('[data-userid]').removeClass('active');
    }
  };
  ...
  Designers = {
    ...
    init: function() {
      if ($('.designer-single').length) {
        return $(window).on('scroll resize', this.scrollHandler);
      }
    },
    scrollHandler: function() {
      ...
      return $('.post-single').each(function() {
        var content, end, height, list_item, this_id, top;
